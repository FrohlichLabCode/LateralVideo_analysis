...
analysisType = 'PSTH';  %'Spectra','FC','Pupil','PSTH','Saccades'
...
for iAnimal = 3%1:numel(animals)
    ...
    elseif cluster == 1
        ...
        GroupAnalysisDir = ['/pine/scr/h/w/angelvv/FerretData/' animalCode '/GroupAnalysis/' analysisType '/'];
...
for irec = 1:numel(fileInfo)%0169 -- 54:numel(fileInfo) %use parfor for cluster
